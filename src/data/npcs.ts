...
export const NPCS: NpcDef[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    giftLines: {
      love: [
        'おっ、{item}! これは いい。よその島じゃ 見ないんだよ、こういうのは。',
        'ありがとう。……売らないよ。これは ぼくの ぶんだ。',
      ],
      like: ['{item}かい。うれしいね、この島の においが する。', 'かばんの おくに しまっておくよ。'],
      ok: ['{item}を ぼくに? ……ありがとう。', 'こういうのが いちばん うれしいんだ。'],
    },
    // そのものにしか言えない反応(なぜ うれしいのか の理由つき)
    giftLinesByItem: {
      glassfloat: [
        'これは……{item}じゃないか! ながれついたのを ひろったんだね。',
        'ぼくは いつも 出ていくばかりで、ながれついたことが ないんだ。だから すきなんだよ、これが。',
      ],
    },
    ...
    greetings: [
      ...
      [
        'いらっしゃい。ぼくは テン、この いちばの 店の ぬしだよ。',
        'よその島の ものなら なんでも あるよ。見ていって。',
      ],
      // 3〜6: 名まえで よんでくれる。旅の話をしはじめる
      [
        'また来てくれたんだね! きょうは いい しなが 入ってるよ。',
        'ぼくの 品は 週ごとに 入れかわるんだ。おなじものは 二度と ならばないかもね。',
      ],
      // 7〜10: 友だち。行商人が「まっている」と言う
      [
        'きみの あしおとは わかるようになったよ。……なんでだろうね。',
        'つぎの でんしゃまで、ゆっくりしていって。ぼくは どこへも 行かないから。',
      ],
    ],
