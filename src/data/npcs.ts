 ...
 */
export type NpcArea = 'island' | 'cove' | 'market';
...
export const NPCS: NpcDef[] = [
  {
    ...
    giftLines: {
      ...
      like: ['{item}だ! はまべで ひろったの?', 'ぼくの たからばこに 入れておくね。'],
      // 1行めは 5人とも ちがう文にしてある(だれに あげたのか 声で わかるように)。
      // ミナモは 元気で「!」が おおい
      ok: ['{item}だ! ぼくに くれるの? やったあ!', 'なんだか うれしいな。'],
    },
    /**
     * そのものにしか言えない反応。ミナモは **つったもの・はまで ひろったもの**に反応する
     * (giftLoves=さかな4種 / giftLikes=かいがら・うきだま と そろえてあり、
     *  なかよし度の増えかたは これまでどおり tier のまま)。
     */
    giftLinesByItem: {
      fish: ['{item}! ぼくの いちばん すきな さかなだよね。', 'きょうのは いい かおを してる。ありがとう!'],
      nightfish: ['{item}だ! よるの 池で つったんだね。', 'この 光りかた、なんど 見ても すきだなあ。'],
      seafish: ['わあ、{item}! 海の さかなは せなかが あおいんだよね。', 'やいたら あまいんだ。ありがとう!'],
      rarefish: ['{item}……! よるの 海の、まぼろしの さかなだよ。', 'ぼく まだ 2ひきしか 見たこと ないんだ。ありがとう!'],
      shell: ['{item}だ! はまべの すなの 上で ひろったんだよね。', 'みみに あてると 海の おとが するんだよ。'],
      glassfloat: ['{item}! あさの はまに ながれつくやつだよね。', 'ぼくの さおの となりに ならべておくよ。'],
    },
    ...
    greetings: [
      // ミナモの声: ぼく / きみ / 「〜だよね」+「!」。かな中心・分かち書きは 第2〜3章とそろえてある
      ['やあ! きみが あたらしい子だね。ぼくは ミナモ。', 'きょうは どのへんで つろうかな〜!'],
      ['お、来たね! きょうも つり日よりだ。', 'ヨザカナって しってる? よるの 池で 光るんだよね。'],
      // v17.1 しょうごうの ひとこと(5人に 1行ずつ)。しょうごうは バッジの かずで
      // かわるので、いちばん なかよしの 段で「そう よばれているよ」と 教える
      ['きみと つりする時間、けっこう すきなんだよね。', 'こんど いっしょに よづり しようよ!',
        'きみの しょうごう、また ふえるといいね! バッジの かずで かわるんだよね。'],
    ],
    ...
    dailyLines: [
      ...
      // v20第3章への伏線。とうだいが ともる前でも あとでも 読める言いかたにしてある
      // (「あれは 何だろうね」の 問いかけどまり。指示形にはしない)
      'よるの うみを、あかりが すーっと よこぎっていくんだ。あれ、なんだろうね。',
    ],
  ...
  },
  {
    ...
    giftLines: {
      ...
      // ノクトの1行め(5人それぞれ ちがう文)。「〜のか」「かたじけない」が この人の口ぶり
      ok: ['{item}を くれるのか。かたじけない。', 'たいせつに するぞい。'],
    },
    /**
     * そのものにしか言えない反応。ノクトは **空から来たもの・光るもの**に反応する
     * (giftLoves=ほしのかけら・きんのかけら・オオクワガタ /
     *  giftLikes=ルミナこうせき・きらきらの石・ヒカリゴケ と そろえてある)。
     */
    giftLinesByItem: {
      starshard: ['おお……{item}か。そらから おちてきた かけらじゃ。', 'これを 見ると、星が ちかく 見えるのう。'],
      gold_piece: ['{item}じゃと? つちの 中で どれだけ ねむっておったのやら。', 'ワシの つくえの まん中に かざるぞい。'],
      b_ookuwa: ['{item}か! よるの 木にしか おらん むしじゃ。', 'よく つかまえたのう。おぬしは 夜の 目を もっておる。'],
      ore: ['{item}じゃな。この 光は 星の 光に よう にておる。', 'ふむ、けんきゅうが すすむわい。'],
      shiny_stone: ['{item}か。みがいたように つやつやじゃ。', 'ワシの ぼうえんきょうの となりに おこう。'],
      moss: ['{item}じゃな。よるに 見ると よう 光る。', 'これで 手もとが あかるく なるわい。'],
    },
    ...
    greetings: [
      ...
      ['ふぁ……ワシは ノクト。よるに ならんと あたまが まわらんのじゃ。', 'よるの しまは よいぞ。光るもの だらけじゃ。'],
      ['おぬしか。ちょうど 星の きろくを しておった ところじゃ。', 'ヒカリゴケは よるに 見ると よう わかる。おぼえておくと よい。'],
      // v17.1 しょうごうの ひとこと
      ['おぬしと 話すのは たのしいのう。', 'ルミの木の いいつたえ、いつか ぜんぶ 話して やろう。',
        'おぬしの しょうごう、バッジの かずで かわるのじゃぞ。ずかんを 見てみい。'],
    ],
  ...
  },
  {
    ...
    giftLines: {
      ...
      // ツムギの1行め(5人それぞれ ちがう文)。「まあ」「〜わ」が この人の口ぶり
      ok: ['あら、{item}。ありがとう、うれしいわ。', 'だいじに するわね。'],
    },
    /**
     * そのものにしか言えない反応。ツムギは **手わざの ざいりょう**に反応する
     * (giftLoves=のばな・かりくさ / giftLikes=もくざい・こえだ と そろえてあり、
     *  わら・ねんども 工房で つかう品なので ここに 足してある)。
     */
    giftLinesByItem: {
      flower: ['まあ、{item}! いちばん すきな 花なの。', 'まどべの びんに いけておくわね。'],
      cutgrass: ['{item}ね。これで さおの にぎりを まくのよ。', 'やわらかいのを えらんでくれたのね。ありがとう。'],
      wood: ['{item}ね。……こんこん。うん、いい おとが するわ。', 'しんの とおった 木よ。だいじに つかわせてね。'],
      twig: ['{item}? こまかい ところに ちょうど いいのよ。', 'ほうきの えに するの。とっておくわね。'],
      straw: ['{item}ね。あんで マットに するのよ。', 'ほすと いい においが するの。ありがとう。'],
      clay: ['{item}ね。やくと つぼに なるのよ。', 'こんど できあがったら 見にきてね。'],
    },
    ...
    greetings: [
      ...
      ['いらっしゃい。ゆっくり していってね。', 'かぐの ことなら、なんでも 聞いてちょうだい。'],
      ['あら、こんにちは! きょうは 何を つくろうかしら。', 'あなたの おいた かぐ、いい センスね。'],
      // v17.1 しょうごうの ひとこと
      ['あなたが 来てから、しまが にぎやかに なったわ。', 'ベリージャム、こんど いっしょに つくりましょうよ。',
        'あなたの しょうごう、バッジの かずで かわるのよ。ずかんで 見られるわ。'],
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    giftLines: {
      ...
      // ロカの1行め(5人それぞれ ちがう文)。言いよどみの「……」が この子の しるし
      ok: ['{item}を ぼくに? ……ありがとう。', 'うれしいな。とうだいに かざっても いい?'],
    },
    /**
     * そのものにしか言えない反応(なぜ うれしいのか の理由つき)。
     * ロカは **海から 来たもの・光るもの**に反応する
     * (giftLoves=ひかりの貝・さかな4種・タツノオトシゴ / giftLikes=ルミベリー)。
     * 声は「……」の言いよどみと「〜なんだ」でそろえてある。
     */
    giftLinesByItem: {
      lightshell: [
      ...
      seahorse: [
        'えっ、{item}……? とうだいが ともってから 来た子だ。',
        'ぼくの あかりが よんだのかな。……そうだと いいな。',
      ],
      shell: [
        '{item}……ぼく、これを ならべるのが すきなんだ。',
        'かいだんの 42だんめに、ひとつずつ おいてるんだよ。',
      ],
      starweed: [
        'あ、{item}だ。のはらの ぎんいろの くさ……。',
        'これを かざると、へやが すこし 星の においに なるんだ。',
      ],
      berry: [
        '{item}? ……ぼく、あまいものを もらうの はじめてなんだ。',
        'よるの ばんの ときに、ひとつぶずつ たべるね。',
      ],
      glassfloat: [
        '{item}……とおくの 海から ながれてきたんだね。',
        'ぼくの とうだいの 光も、そこまで とどいたかな。',
      ],
    },
  ...
  // ---------------------------------------------------------------------------
  // v20第3章 テン(イタチの行商人)。くらしているのは「いちば島」。
  // debutFlag('market_arrived')が true になるまで NPCSystem は実体を作らない
  // (フラグは はじめて いちば島へ ついたときに立つ。src/scenes/GameScene.ts applyMarket)。
  // 立ち位置は src/data/island.ts の NPC_SPOTS.ten(いちば島の世界座標)。
  //
  // ロカと同じく **「家に帰る(activity:'home')枠を作らない」**:
  // いちば島へは 2日に1度の でんしゃでしか 行けないので、
  // 着いた時刻に テンが 留守だと「わざわざ わたったのに 会えない」になる(教訓3)。
  // 行商人は 店を あけているもの、という設定が そのまま 導線の安全になっている。
  // ---------------------------------------------------------------------------
  {
    id: 'ten',
    charId: 'ten',
    ...
    giftLines: {
      love: [
        'おっ、{item}! これは いいね。よその しまじゃ 見ないのさ。',
        'ありがとう。……売らないよ。これは ぼくの ぶんさ。',
      ],
      like: ['{item}かい。うれしいね、この しまの においが する。', 'かばんの おくに しまっておくよ。'],
      // テンの1行め(5人それぞれ ちがう文)。行商人らしい「〜じゃないか」「〜さ」でそろえる
      ok: ['おや、{item}じゃないか。ぼくに くれるのかい?', 'こういうのが いちばん うれしいのさ。'],
    },
    /**
     * そのものにしか言えない反応(なぜ うれしいのか の理由つき)。
     * テンは **よその しまでは 手に入らないもの**に反応する
     * (giftLoves=うきだま・きらきらの石・きんのかけら・ニジイロクワガタ /
     *  giftLikes=かいがら・ほしのかけら・ベリージャム)。
     * 声は「〜さ」「〜じゃないか」と **数を かぞえる くせ** でそろえてある。
     */
    giftLinesByItem: {
      glassfloat: [
        'これは……{item}じゃないか! ながれついたのを ひろったんだね。',
        'ぼくは 出ていくばかりで、ながれついたことが ないのさ。だから すきなんだ。',
      ],
      shiny_stone: [
        'ほう、{item}か。ぼくの めききで 上の上だよ。',
        'こういうのは 3つの しまを まわって ひとつ 出るか どうかさ。',
      ],
      gold_piece: [
        'おっと、{item}じゃないか。ずっしり くるね。',
        'ぼくの かばんで いちばん おもい ものに なったよ。ありがとう。',
      ],
      b_niji: [
        '{item}! この しまの よるにしか いない子さ。',
        'にじの いろが 7つ。……いや、8つ 見えるな。すごいじゃないか。',
      ],
      shell: [
        '{item}かい。ぼくの かばんには もう 12こ 入ってるんだ。',
        'ひとつずつ かたちが ちがう。だから やめられないのさ。',
      ],
      jam: [
        'わあ、{item}! これは この しまの あじだね。',
        'つぎの しまで、ぼくは これの 話を するのさ。ありがとう。',
      ],
    },
    thanksLetter: 'つぎの島に ついたら、まず きみの島の 話を するよ。',
    // テン専用のレシピ。ほかの4人と同じく「お礼だけが入手経路」
    thanksRecipe: 'r_far_map',
    // いちば島から 島へは わたれないので、朝の来訪には出てこない
    // (willVisitToday が area==='island' の人だけを見る)。それでも 形はそろえておく
    visitPraise: {
      base: ['やあ、きみの家か。……いい におい。人の すんでる においだ。', 'ぼくの 家は かばんの中だからね。'],
     ...
     * どの spot も wanderR:0 なので うろうろ(乱数)をしない=決定論。
     */
    schedule: [
      { from: 6, to: 11, spot: 'lane', activity: 'stroll' }, // 朝は 通りの ちょうちんを 見てまわる
      { from: 11, to: 16, spot: 'stall', activity: 'work' }, // 昼は 店ばん
      { from: 16, to: 20, spot: 'hill', activity: 'watch' }, // 夕方は 丘から 海を見る
      { from: 20, to: 30, spot: 'stall', activity: 'work' }, // 夜の いちばが 本番
    ],
    questEntry: { from: 0, to: 30, spot: 'stall', activity: 'work' },
    greetings: [
      // テンの声: ぼく / きみ / 「〜さ」「〜じゃないか」+ 数を かぞえる くせ
      // なかよし度 0〜2: 商売の顔。ていねいだが 少し よそゆき
      [
        'いらっしゃい。ぼくは テン、この いちばの みせの ぬしさ。',
        'よその しまの ものなら なんでも あるよ。見ていってよ。',
      ],
      // 3〜6: 名まえで よんでくれる。旅の話をしはじめる
      [
        'また来てくれたんだね! きょうは いい しなが 入ってるよ。',
        'ぼくの しなは まいしゅう 入れかわるのさ。おなじものは 二どと ならばないかもね。',
      ],
      // 7〜10: 友だち。行商人が「まっている」と言う
      [
        'きみの あしおとは わかるように なったよ。……なんでだろうね。',
        'つぎの でんしゃまで ゆっくりしていって。ぼくは どこへも いかないからさ。',
        // v17.1 しょうごうの ひとこと
        'きみの しょうごう、いま いくつめだい? バッジの かずで かわるのさ。',
      ],
    ],
    // ふだんの ひとこと(いちば・旅・よその島の話題)。日付で1つ選ぶ
    dailyLines: [
      'ぼくの 店はね、週が かわると しなが ぜんぶ 入れかわるんだ。おなじ週に 来るのが こつだよ。',
      'よその島には、ゆきの ふる島も あるんだって。ぼくは まだ 見たことがない。',
      'この 風呂敷、おじいさんの おさがりなんだ。もう 三代 つかってる。',
      'でんしゃはね、うみの上を すべってるだけで、レールなんて ないんだよ。ふしぎだろ?',
      'ちょうちんは 一つでも きえてると さびしいんだ。だから まいばん 数えてる。',
      // かおりのはの つかい道の ヒント(答えの数は言わない)
      'かおりのはを もくざいの うつわで たいたら、いい におい の あかりに ならないかな。',
    ],
  },
];
