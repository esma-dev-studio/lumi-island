...
export const QUESTS: QuestDef[] = [
  {
    ...
    offer: [
      'いらっしゃい。あなたが あたらしく 来た子ね。',
      'わたしは ツムギ。ここで かぐを つくっているの。',
      'さっそくだけど、おねがいが あるのよ。',
      'かぐの もとに なる「もくざい」が たりなくて……。',
  ...
  },
  {
    ...
    progress: 'サカナを 1ぴき つろう',
      ...
      'おー! つれたね! センスあるよね〜。',
      'おれいに ルミナと「ベリージャム」の レシピを あげる!',
      'ベリー3つで できて、高く 売れるんだ。すごいよね!',
    ],
  ...
  },
  {
    ...
    offer: [
      ...
      'あれの 光には、ふしぎな 力が あるんじゃ。',
      'ツルハシで 3つほど、ほってきて くれんかの。',
    ],
    progress: 'ルミナこうせきを ほろう',
    done: [
      'ほほう……やはり よい 光じゃ。ありがとう。',
      'おれいに「いしのランプ」の つくりかたを おしえよう。',
      '夜の しまを てらす、よい あかりに なるぞ。',
    ],
  ...
  },
  {
    ...
    unlocks: [],
    offer: [
      'ひろばの 大きな 木……あれが「ルミの木」よ。',
      'しまの あかりが ふえると 目を さますって 言われているの。',
      '光る かぐ(ランタンや いしのランプ)を、しまに 3つ おいてみて!',
    ],
    progress: 'ひかる かぐを しまに 3つ おこう',
    done: [
      '……見て! ルミの木が 光ってる!',
      'しまが こんなに あかるく なるなんて……。ほんとうに ありがとう!',
      'これからも、この しまで いっしょに くらして いこうね。',
    ],
