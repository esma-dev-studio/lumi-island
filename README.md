...
- **虫あみ**(こえだ2+クサツル2)… 島にいる**虫6種**を**E**でつかまえられます。昼はモンシロチョウ・アゲハチョウ・テントウムシ・(まれに)カブトムシ、夜はホタル・スズムシ。**虫のほうへ走って近づいてE**でつかまえられます(近づくと「むしが いる! ちかづいて つかまえよう」→「**E**むしあみでつかまえる」の順にヒントが出ます)。あまり長く近くにいると にげますが、にげた虫は**近くの花や草にとまり直す**ので、追いかければまたねらえます。1匹つかまえると「**むしかご**」のレシピをひらめきます(置くと、さいごにつかまえた虫が中に見えます)。
