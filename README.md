...
- **虫あみ**(こえだ2+クサツル2)… **虫19種**(カブト・クワガタ族は10種)を**E**でつかまえられます。島の昼はモンシロチョウ・アゲハチョウ・テントウムシ・バッタ・トンボ(夕方)・セミ・ノコギリクワガタ・クワガタ・カマキリなど、夜はホタル・スズムシ・カブトムシ・ヒラタクワガタ・オオクワガタ・ギラファノコギリ(レア)。**ミヤマクワガタとコーカサスオオカブトは よるの入り江だけ**、**ニジイロクワガタとヘラクレスオオカブト(最レア)は いちば島だけ**に出ます。日がわりで「きょうの顔ぶれ」が入れかわります。**虫のほうへ走って近づいてE**でつかまえられます(近づくと「むしが いる! ちかづいて つかまえよう」→「**E**むしあみでつかまえる」の順にヒントが出ます)。あまり長く近くにいると にげますが、にげた虫は**近くの花や草にとまり直す**ので、追いかければまたねらえます。1匹つかまえると「**むしかご**」のレシピをひらめきます。むしかごは置いたあと、そばで**E**を押すと「**いきものを いれる**」のパネルが開き、**持っている虫から1ぴきをえらんで**入れられます(入れた虫がかごの中に見え、とりだすと もちものに戻ります)。はじめて1ぴき入れると「**おおきな むしかご**」(**3びき**まで入る)のレシピをひらめきます。
