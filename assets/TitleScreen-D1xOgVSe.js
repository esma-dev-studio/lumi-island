import{G as o,m as i,s as d,H as l,n as c,o as r}from"./index-DbFMsobL.js";class u{el;onStart=null;constructor(){this.el=document.createElement("div"),this.el.className="title-screen",document.getElementById("ui-root").appendChild(this.el),this.render()}render(){const n=o(),e=i();this.el.innerHTML=`
