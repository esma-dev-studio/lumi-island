import{bj as w,aP as u,bk as p,s as m,bl as b,aQ as $,aR as h,bm as y,bn as x,bo as v,bp as g,bq as k,br as M}from"./index-DzF9X-gH.js";import{b as S,H as L,a as B}from"./helpText-Q6u2mfU6.js";const E={badJson:"ファイルの 中みが こわれているみたい。",notBundle:"これは ルミ島の セーブファイルでは ないみたい。",futureFormat:"これは もっと あたらしい ルミ島の ファイルみたい。",checksum:"ほぞんしたあとに 中みが かわっているみたい。",badSave:"中の セーブデータが よみとれなかった。"};function d(r){return`<div class="tm-sum"><span>${r.day}にちめ</span><span>ルミナ ${r.lumina}</span><span>バッジ ${r.badges}こ</span></div>`}function f(r){if(!r)return"";const t=new Date(r),n=a=>String(a).padStart(2,"0");return`${t.getMonth()+1}/${t.getDate()} ${n(t.getHours())}:${n(t.getMinutes())}`}class T{el;onStart=null;constructor(){this.el=document.createElement("div"),this.el.className="title-screen",document.getElementById("ui-root").appendChild(this.el),this.render()}render(){const t=w(),n=u(),a=p().filter(e=>e.summary!==null),c=this.el.querySelector(".title-extra:not(.hidden)")?.dataset.panel??"",s=e=>c===e?"":"hidden";this.el.innerHTML=`
      <div class="title-inner">
        ...
        <div class="title-credit">オリジナル作品 / 3Dモデル・音はすべてプログラム生成 <span class="title-ver">v14.1</span></div>
      </div>
