import{ab as e}from"./index-Ndx-k36r.js";const r="prePassDeclaration",l=`#ifdef PREPASS
...
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=n);const f="shadowsFragmentFunctions",m=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=m);const s="samplerFragmentDeclaration",S=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=S);const v="reflectionFunction",x=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
