const t="touch-root",e="touch-ui";let p=null;function o(){return typeof document>"u"?null:(p&&p.isConnected||(p=document.querySelector(`.${t}`)),p)}function b(){if(typeof document>"u")return!1;const n=o();return n?!n.classList.contains("hidden"):document.documentElement.classList.contains(e)?!0:typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(pointer: coarse)").matches}function k(n,a){return b()?a:n}const c=/<kbd>\s*(?:E|Space)\s*<\/kbd>/gi;function i(n){if(!n)return"";let a=n.replace(c,"");const d=a.search(/<kbd>/i);return d>=0&&(a=a.slice(0,d)),a.trim()}const s=n=>`<div class="help-sec">${n}</div>`,u=`
            ${s("うごく")}
            ...
            <span>右上の「メニュー」</span><span>とじる・メニュー</span>`;export{r as H,u as a,k as b,i as h,b as i};
